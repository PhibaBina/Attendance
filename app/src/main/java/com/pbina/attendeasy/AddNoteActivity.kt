...
class AddNoteActivity : AppCompatActivity() {
    ...
    private lateinit var etNoteLink: TextInputEditText
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        etNoteLink = findViewById(R.id.etLink)
        ...
        btnSubmit.setOnClickListener {
            if (validateForm()) {
                ...
                val link = etNoteLink.text.toString().trim()
                ...
                selectedDepartmentId?.let { deptId ->
                    firestore.collection("Department")
                        ...
                        .addOnSuccessListener { result ->
                            ...
                            val adapter = ArrayAdapter(this@AddNoteActivity, android.R.layout.simple_spinner_item, subjects)
                            adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item)
                            spinnerSubject.adapter = adapter
                        }
                        .addOnFailureListener {
                            Toast.makeText(this@AddNoteActivity, "Failed to load subjects", Toast.LENGTH_SHORT).show()
                        }
                }
            }
    ...
    private fun validateForm(): Boolean {
        ...
        if (etNoteLink.text.isNullOrEmpty()) {
            etNoteLink.error = "Enter note link"
            return false
        }
        ...
        if (!etNoteLink.text.toString().startsWith("http")) {
            etNoteLink.error = "Please enter a valid link (starting with http or https)"
            return false
        }
